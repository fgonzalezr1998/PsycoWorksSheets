...
public class SidePanelActivity extends AppCompatActivity implements DatabaseHandler.ValueListener.UserListener {
    ...
    public void setUser(DatabaseHandler.User user) {
        ...
        if (selectedUser == null) {
            ...
            sidePanelEmail.setText(selectedUser.getEmail());
        }
    }
}